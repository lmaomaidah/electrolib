...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The Shelf" },
      { property: "og:description", content: "Your stories, beautifully shelved." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Henny+Penny&family=Mystery+Quest&family=Crafty+Girls&family=EB+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Lora:wght@400;500;600;700&display=swap",
      },
    ],
  }),
